...
// Type: WinPhoneTango.Data.GroupBackgroundBrushColorConverter
...
{
  public class GroupBackgroundBrushColorConverter : IValueConverter
  {
    public object Convert(object value, Type targetType, object parameter, string language)
    {
      ...
      object resource = (object) (SolidColorBrush) Application.Current.Resources[(object) "TangoOrangeBrush"];
      if (publicGrouping != null && publicGrouping.Count == 0)
        resource = (object) (SolidColorBrush) Application.Current.Resources[(object) "TangoChromeBrush"];
      return resource;
    }
